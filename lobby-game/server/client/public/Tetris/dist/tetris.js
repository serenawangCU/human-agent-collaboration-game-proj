...
var changePlayer = function(){
	document.getElementById('player').innerHTML = isPlayerOne ? 'Player1' : 'Player2';
...
Tetris.prototype = {
	...
	_keydownHandler:function(e){
		...
		if (!isPlayerOne) {
			...
			switch(e.keyCode){
				case 65:{this.shape.goLeft(matrix);this._draw();}
				break;
				
				case 68:{this.shape.goRight(matrix);this._draw();}
				break;
				
				case 87:{this.shape.rotate(matrix);this._draw();}
				break;
	
				case 83:{this.shape.goDown(matrix);this._draw();}
				break;
	...
	_check:function(){
		...
		changePlayer();
		console.log("next block " + isPlayerOne);
	},
